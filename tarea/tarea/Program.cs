                ...
                if (opcion == 1)
                {
                    for (int i = 0; i < facturas.Length; i++)
                    {
                        ...
                        do
                        {
                            ...
                            {
                                Console.WriteLine("La opcion que ingresó no existe. Intente de nuevo.\n");
                            }
                        ...
                        do
                        {
                            ...
                            {
                                Console.WriteLine("Seleccione una de las casetas: 1, 2, o 3");
                            }
